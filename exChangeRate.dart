...
import 'package:mobile_legder_v2/store/LoginData.dart';
...
void main() => runApp(MobileLedger());

class MobileLedger extends StatefulWidget {
  @override
  _MobileLedgerState createState() => _MobileLedgerState();
}

class _MobileLedgerState extends State<MobileLedger> {
  @override
...
//        '/detail': (_) => new An(),
//      },
      routes: <String, WidgetBuilder>{'/a': (_) => An(), '/b': (_) => Some()},
      title: 'Mobile_Legder_v2',
      home: ChangeNotifierProvider<LoginData>(
...
//                      leading: Icon(Icons.attach_money),
                      leading: 
                      FadeInImage.assetNetwork(width: 50,height: 50,placeholder: 'assets/loading.gif', image: returnUrl(nation[flags])),
//                      Image.network(
